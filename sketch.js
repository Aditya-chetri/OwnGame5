...
var jumping, walking, normal, out, win;
...
function preload(){
  ...
  brick = loadImage("StoneBlock.png")
  cloudb = loadImage("Cloud.png")
  eagle = loadImage("Eagle.png")
  mountain = loadImage("moun.png")
  won = loadImage("Win.png");
}

function setup() {
  createCanvas(13500,650);
  ...
  topArrow.scale = 0.1;
  part5 = createSprite(2590, 440, 50, 20)
  part5.scale = 0.4;
  part6 = createSprite(3000, 400, 50, 20);
  part6.scale = 0.4
  part7 = createSprite(3500, 400, 50, 50);
  part7.scale = 0.4;
  part8 = createSprite(4000, 400, 50, 50);
  part8.scale = 0.4;
  part9 = createSprite(4500, 400, 50, 50);
  part9.scale = 0.4;
  part10 = createSprite(5000, 400, 50, 50);
  part10.scale = 0.4;
  part11 = createSprite(5500, 400, 50, 50);
  part11.scale = 0.4;
  part12 = createSprite(6000, 400, 50, 50);
  part12.scale = 0.4;
  ob2 = createSprite(2500, 410, 20, 20);
  ob2.scale = 0.1;
  ob3 = createSprite(3500, 370, 50, 50);
  ob3.scale = 0.1;
  part13 = createSprite(6500, 400, 50, 50);
  part13.scale = 0.6;
  part14 = createSprite(7000, 400, 50, 50);
  part14.scale = 0.6;
  ob4 = createSprite(7000, 360, 50, 50);
  ob4da1 = createSprite(7025, 360, 50, 50);
  ob4da1.scale = 0.3;
  ob4.scale = 0.3;
  part15 = createSprite(7500, 400, 50, 50);
  part15.scale = 0.6;
  part16 = createSprite(8000, 400, 50, 50);
  part16.scale = 0.6
  part17 = createSprite(8500, 400, 50, 50);
  part17.scale = 0.6;
  ob5 = createSprite(8500, 360, 50, 50);
  ob5.scale = 0.3;
  ob5da1 = createSprite(8525,360, 50, 50)
  ob5da1.scale = 0.3;
  part18 = createSprite(9050, 400, 50, 50);
  part18.scale = 0.6
  part19 = createSprite(9600, 400, 50, 50);
  part19.scale = 0.6;
  part20 = createSprite(10000, 400, 50, 50);
  part20.scale = 0.2;
  ob6 = createSprite(10000, 360, 50, 50);
  ob6.scale = 0.4;
  part21 = createSprite(10350, 400, 50, 50);
  part21.scale = 0.3;
  part22 = createSprite(10700, 380, 50, 50);
  part22.scale = 0.3;
  part23 = createSprite(11050, 370, 50, 50);
  part23.scale = 0.3
  part24 = createSprite(11400, 360, 50, 50);
  part24.scale = 0.3;
  part25 = createSprite(11750, 350, 50, 50);
  part25.scale = 0.3;
  part26 = createSprite(12150, 340, 50, 50);
  part26.scale = 0.3;
  end = createSprite(13000, 200, 50, 50);
  end.scale = 5;
  win = createSprite(12000, 200, 50, 50);
  win.scale = 0.5;
  win.visible = false;
  finish = createSprite(13000, 500, 1800, 20);
  finish.visible = false;
  
  win.addImage(won);
  end.addImage(mountain)
  part26.addImage(cloudb);
  part25.addImage(cloudb);
  part24.addImage(cloudb);
  part23.addImage(cloudb)
  part22.addImage(cloudb);
  part21.addImage(cloudb)
  ob6.addImage(eagle);
  part20.addImage(cloudb);
  part19.addImage(brick);
  part18.addImage(brick);
  ob5.addImage(spike);
  ob5da1.addImage(spike);
  part17.addImage(brick);
  part16.addImage(brick)
  part15.addImage(brick);
  ob4da1.addImage(spike);
  ob4.addImage(spike);
  part14.addImage(brick);
  part13.addImage(brick);
  ob3.addImage(snake);
  ob2.addImage(snake);
...
function draw() {
  ...
  if((player.collide(outGround))||(player.collide(ob1))||(player.collide(ob2))||(player.collide(ob3))||(player.collide(ob4da1))
      ||(player.collide(ob4))||(player.collide(ob5da1))||(player.collide(ob5))||(player.collide(ob6))&&(gameState==="normal")){
    gameState = "out";
    player.y = 780;
  }
  ...
  player.collide(ob2);
  player.collide(part13);
  player.collide(part14);
  player.collide(ob4);
  player.collide(ob4da1);
  player.collide(part15);
  player.collide(part16);
  player.collide(part17);
  player.collide(ob5da1);
  player.collide(ob5);
  player.collide(part18);
  player.collide(part19);
  player.collide(part20);
  player.collide(ob6);
  player.collide(part21);
  player.collide(part22);
  player.collide(part23);
  player.collide(part24);
  player.collide(part25);
  player.collide(part26);
